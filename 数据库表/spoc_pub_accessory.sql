...
--
-- Table structure for table `pub_accessory`
--
...
CREATE TABLE `pub_accessory` (
  ...
  `pub_accessory_name` varchar(255) DEFAULT NULL,
  `pub_accessory_path` varchar(255) DEFAULT NULL,
  `pub_accessory_time` datetime DEFAULT NULL,
  `task_id` varchar(35) DEFAULT NULL,
  `delete_flag` int(1) DEFAULT NULL,
  PRIMARY KEY (`pub_accessory_id`),
...
--
-- Dumping data for table `pub_accessory`
--

LOCK TABLES `pub_accessory` WRITE;
/*!40000 ALTER TABLE `pub_accessory` DISABLE KEYS */;
/*!40000 ALTER TABLE `pub_accessory` ENABLE KEYS */;
UNLOCK TABLES;
