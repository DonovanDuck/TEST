...
CREATE TABLE `teacher_project` (
  `teacher_project_id` varchar(255) NOT NULL,
  `teacher_project_name` varchar(255) DEFAULT NULL,
  `teahcer_project_detail` varchar(255) DEFAULT NULL,
  `declare_time` datetime DEFAULT NULL COMMENT '申报时间',
  `approval_time` datetime DEFAULT NULL COMMENT '审批时间',
  `finish_time` datetime DEFAULT NULL,
  `approval_organization` varchar(255) DEFAULT NULL COMMENT '审批部门',
  `fund` int(11) DEFAULT NULL COMMENT '资助金额',
  `level` varchar(255) DEFAULT NULL COMMENT '一般，重点',
  `teacher_project_category` varchar(255) DEFAULT NULL COMMENT '教学改革，科学研究',
  PRIMARY KEY (`teacher_project_id`)
