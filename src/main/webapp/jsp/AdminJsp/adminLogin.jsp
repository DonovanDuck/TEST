...
<body>
    <div class="div1">
        ...
        <strong>学号：  </strong>
        <input type="text" id="adminUsername" name="adminUsername" style="width: 70%;line-height: 30px;background: white;margin-bottom: 4%;" placeholder="请输入学号" autofocus> <br>
        <strong>密码： </strong>
        <input type="password" id="adminPassword" name="adminPassword" style="width: 70%;line-height: 30px;background: white;margin-bottom: 4%;" placeholder="请输入密码" > <br>
        <input type="radio"> 
        <span>记住密码</span> 
         <a href="">忘记密码？</a> 
         <br>
