		...
		<div class="col-md-12 IURP panel panel-default"
			...
			<div class="form-group">
				<label for="declaration">申报书</label> <input type="text"
					class="form-control" id="declaration" name="declaration" placeholder="申报书">
			</div>
			<div class="form-group">
				<label for="midreply">中期检查</label> <input type="text"
					class="form-control" id="midreply" name="midreply" placeholder="中期检查">
			</div>
			<div class="form-group">
				<label for="concludingRreport">结题报告</label> <input type="text"
					class="form-control" id="concludingRreport" name="concludingRreport" placeholder="结题报告">
			</div>
			<div class="form-group">
